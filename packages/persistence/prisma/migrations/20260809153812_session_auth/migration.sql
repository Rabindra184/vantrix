...
CREATE TABLE "org_member" (
    ...
    CONSTRAINT "org_member_pkey" PRIMARY KEY ("user_id","org_id")
);
...
-- RenameIndex
ALTER INDEX "run_error_run_scope_name_message_key" RENAME TO "run_error_run_id_scope_name_message_key";
