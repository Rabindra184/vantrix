 ...
 */
/* 12px SENTENCE-CASE SANS (review m01). 11px uppercase mono across thirteen
   columns of the statistics table read as a row of stencils and cost width no
   column could spare — `Cnt/s` and `95th` are already terse, and uppercasing
