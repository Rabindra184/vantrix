...
its diff is one docstring. Unit stays **160 / 2014**, integration **144 / 1832**
...
to do" and "nobody checked" look identical in a month. RE-MEASURED after
merging `main`: partitions-do-not-run-out-silently landed underneath it and
added an integration FILE, so the integration floor this branch sits on is
**144 / 1832**, not the 143 / 1831 it was cut from. **A FLOOR IS A PROPERTY
OF A TREE**, even for a branch that changes nothing executable.
...
integration figure moved a second time before this ever merged. That branch
needed the identical reconciliation against the identical merge an hour
earlier, which is the third time this file records it: **a floor is a property
of a TREE, and an open branch's tree changes under it.**
...
case's list. Cut from **155 / 1990**, it measured integration 138 / 1808 on
...
records two branches cut from one `main` and only one of them able to stay
true. No product code: the whole diff is one
